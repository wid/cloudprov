...
import (
	...
	cloudprovcontrollerv1alpha1 "cloudprov.org/cloudprov-controller/pkg/apis/cloudprovcontroller/v1alpha1"
	versioned "cloudprov.org/cloudprov-controller/pkg/generated/clientset/versioned"
	internalinterfaces "cloudprov.org/cloudprov-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "cloudprov.org/cloudprov-controller/pkg/generated/listers/cloudprovcontroller/v1alpha1"
...
// one. This reduces memory postgrestprint and number of connections to the server.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Postgreses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Postgreses(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudprovcontrollerv1alpha1.Postgres{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *postgresInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudprovcontrollerv1alpha1.Postgres{}, f.defaultInformer)
}
