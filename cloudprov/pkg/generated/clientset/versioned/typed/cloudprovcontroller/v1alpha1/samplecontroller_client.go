...
import (
	v1alpha1 "cloudprov.org/cloudprov-controller/pkg/apis/cloudprovcontroller/v1alpha1"
	"cloudprov.org/cloudprov-controller/pkg/generated/clientset/versioned/scheme"
...
// SamplecontrollerV1alpha1Client is used to interact with features provided by the cloudprov.org group.
type SamplecontrollerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SamplecontrollerV1alpha1Client) Postgreses(namespace string) PostgresInterface {
