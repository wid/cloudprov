...
import (
	...
	scheme "cloudprov.org/cloudprov-controller/pkg/generated/clientset/versioned/scheme"
...
func newPostgreses(c *SamplecontrollerV1alpha1Client, namespace string) *postgreses {
	return &postgreses{
		client: c.RESTClient(),
		ns:     namespace,
	}
